...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden bg-navy-950">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full z-10">
          ...
          >
            <span className="text-xs uppercase tracking-[0.2em] font-semibold text-royal-400 bg-royal-500/10 border border-royal-500/20 px-4.5 py-1.5 rounded-full w-fit">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight font-display">
              ...
              <span className="text-gradient">Digital Solutions</span> Partner
            </h1>
            <p className="text-sm md:text-base text-gray-400 leading-relaxed max-w-xl">
              Helping businesses scale with Professional Virtual Assistance, Web Development, Project Management, Administrative Support, Insurance Back Office, Data Processing, School ERP, and E-commerce Automation.
            </p>
            <div className="flex flex-wrap gap-4 mt-4">
              ...
              <a
                href="#contact"
                className="px-8 py-4 text-sm font-semibold rounded-full glass text-white border-white/10 hover:bg-white/10 hover:border-royal-500/40 hover:scale-[1.03] transition-all"
              >
                Get Quote
              </a>
            </div>
      ...
      <section id="about" className="py-24 bg-navy-950/40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="flex flex-col gap-6"
            >
              <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Who We Are</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                <div className="glass p-5 rounded-2xl">
                  <h4 className="font-bold text-white mb-2 flex items-center gap-2 text-sm uppercase tracking-wide font-display">
                    <FaRocket className="text-royal-400" /> Our Mission
                  </h4>
                ...
                <div className="glass p-5 rounded-2xl">
                  <h4 className="font-bold text-white mb-2 flex items-center gap-2 text-sm uppercase tracking-wide font-display">
                    <FaLightbulb className="text-royal-400" /> Our Vision
                  </h4>
                  <p className="text-xs text-gray-400 leading-relaxed">
            ...
            >
              <div className="glass-card p-8 rounded-3xl text-center flex flex-col justify-center items-center">
                ...
                <span className="text-xs text-gray-500 uppercase tracking-widest font-semibold">Years Experience</span>
              </div>
              <div className="glass-card p-8 rounded-3xl text-center flex flex-col justify-center items-center">
                <span className="text-4xl lg:text-5xl font-extrabold text-gradient font-display mb-2">250+</span>
                <span className="text-xs text-gray-500 uppercase tracking-widest font-semibold">Projects Completed</span>
              </div>
              <div className="glass-card p-8 rounded-3xl text-center flex flex-col justify-center items-center">
                <span className="text-4xl lg:text-5xl font-extrabold text-gradient font-display mb-2">15+</span>
                <span className="text-xs text-gray-500 uppercase tracking-widest font-semibold">Countries Served</span>
              </div>
              <div className="glass-card p-8 rounded-3xl text-center flex flex-col justify-center items-center">
                <span className="text-4xl lg:text-5xl font-extrabold text-gradient font-display mb-2">98%</span>
                <span className="text-xs text-gray-500 uppercase tracking-widest font-semibold">Client Retention</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id="services" className="py-24 bg-navy-950 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Our Services</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Complete Enterprise Operations Directory</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {activeServices.map((service, idx) => (
              ...
              >
                <div className="p-3 bg-royal-600/10 border border-royal-500/20 rounded-2xl w-fit">
                  {getIcon(service.icon)}
                </div>
                <h4 className="text-lg font-bold text-white font-display">{service.title}</h4>
                <p className="text-xs text-gray-400 leading-relaxed">{service.desc || service.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-navy-950/40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Industries We Serve</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Targeted Back Office Domain Expertise</h3>
          </div>
            ...
            {['Insurance', 'Education', 'Healthcare', 'Real Estate', 'Finance', 'Startups', 'Retail', 'Legal'].map((ind, idx) => (
              <Link href={`/industries/${ind.toLowerCase().replace(' ', '-')}`} key={idx}>
                <motion.div
                  ...
                  className="glass p-6 rounded-2xl flex items-center justify-between group border border-white/5 hover:border-royal-500/30 cursor-pointer"
                >
                  <span className="font-semibold text-white group-hover:text-royal-400 transition-colors">{ind}</span>
                  <FaArrowRight size={12} className="text-gray-500 group-hover:text-white transition-colors" />
                </motion.div>
              </Link>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative flex justify-center">
              <div className="absolute w-72 h-72 bg-royal-500/5 rounded-full blur-[80px]"></div>
              <div className="glass p-8 rounded-3xl flex flex-col gap-6 max-w-md w-full relative z-10 border border-white/10 shadow-2xl">
                ...
                <div className="flex items-center gap-4 text-xs text-white">
                  <span className="flex items-center gap-1.5"><FaShieldAlt className="text-green-400" /> NDA Protected</span>
                  <span className="flex items-center gap-1.5"><FaShieldAlt className="text-green-400" /> ISO Compliant</span>
                </div>
              </div>
            </div>
            ...
            <motion.div
              ...
              className="flex flex-col gap-6"
            >
              <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Why EOG</h2>
              <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Partnering for Scalability & Integrity</h3>
              ...
              <ul className="flex flex-col gap-4 text-sm text-gray-400">
                <li className="flex gap-3"><FaUsers className="text-royal-400 mt-1" /> <span><strong>Dedicated Team</strong>: Resource profiles fully allocated to your queues.</span></li>
                <li className="flex gap-3"><FaShieldAlt className="text-royal-400 mt-1" /> <span><strong>Data Security</strong>: Modern endpoints protection and regular backups.</span></li>
                <li className="flex gap-3"><FaSyncAlt className="text-royal-400 mt-1" /> <span><strong>Scalable structure</strong>: Grow or reduce team members inside a 15-day notice buffer.</span></li>
              </ul>
            </motion.div>
          </div>
        </div>
      ...
      <section id="process" className="py-24 bg-navy-950/40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Our Process</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">How We Onboard & Execute</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step, idx) => (
              <div key={idx} className="glass p-8 rounded-3xl relative border border-white/5 flex flex-col gap-4">
      ...
      {/* --- PORTFOLIO SECTION --- */}
      <section id="portfolio" className="py-24 bg-navy-950 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Case Studies</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Proven Outcomes in the Field</h3>
          </div>
      ...
      <section className="py-24 bg-navy-950/40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-12">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Client Reviews</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">What Our Enterprise Partners Say</h3>
          </div>
      ...
      <section className="py-24 bg-navy-950 relative">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400 mb-12">Technologies We Leverage</h2>
          <div className="flex flex-wrap justify-center gap-6 opacity-40">
            {['React', 'Next.js', 'Node.js', 'Express', 'MongoDB', 'WordPress', 'Laravel', 'PHP', 'Python', 'AWS', 'Google Cloud', 'Docker', 'GitHub'].map((tech) => (
              <span key={tech} className="text-sm font-semibold uppercase tracking-widest text-white border border-white/10 px-4 py-2 rounded-lg">{tech}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-navy-950/40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Pricing Packages</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Transparent Plans Tailored to Scale</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Package 1 */}
            <div className="glass p-8 rounded-3xl flex flex-col justify-between border border-white/5 h-full">
              <div className="flex flex-col gap-4">
                <h4 className="font-bold text-white text-lg">Starter VA</h4>
                <p className="text-xs text-gray-500">For small businesses needing quick inbox/calendar sync assistance.</p>
                <span className="text-3xl font-extrabold text-white mt-4 font-display">$899 <span className="text-xs font-normal text-gray-500">/ month</span></span>
                <ul className="flex flex-col gap-3.5 text-xs text-gray-400 mt-6">
              ...
              <a href="#contact" className="mt-8 block text-center py-3 bg-white/5 hover:bg-white/10 text-white rounded-full text-xs font-semibold uppercase">Get Started</a>
            </div>

            {/* Package 2 */}
            <div className="glass p-8 rounded-3xl flex flex-col justify-between border border-royal-500/30 shadow-xl shadow-royal-500/5 h-full relative">
              <span className="absolute top-4 right-4 text-[9px] uppercase font-bold tracking-widest bg-royal-600/30 text-royal-300 px-2 py-0.5 rounded border border-royal-500/40">Popular</span>
              <div className="flex flex-col gap-4">
                <h4 className="font-bold text-white text-lg">Professional VA</h4>
                <p className="text-xs text-gray-500">For mid-size agencies needing daily operational assistance.</p>
                <span className="text-3xl font-extrabold text-white mt-4 font-display">$1,599 <span className="text-xs font-normal text-gray-500">/ month</span></span>
                <ul className="flex flex-col gap-3.5 text-xs text-gray-400 mt-6">
            ...
            <div className="glass p-8 rounded-3xl flex flex-col justify-between border border-white/5 h-full">
              <div className="flex flex-col gap-4">
                <h4 className="font-bold text-white text-lg">Enterprise SLA</h4>
                <p className="text-xs text-gray-500">For large operations or multi-agent back-office teams.</p>
                <span className="text-3xl font-extrabold text-white mt-4 font-display">$2,999 <span className="text-xs font-normal text-gray-500">/ month</span></span>
                <ul className="flex flex-col gap-3.5 text-xs text-gray-400 mt-6">
            ...
            <div className="glass p-8 rounded-3xl flex flex-col justify-between border border-white/5 h-full">
              <div className="flex flex-col gap-4">
                <h4 className="font-bold text-white text-lg">Custom Solutions</h4>
                <p className="text-xs text-gray-500">For custom web applications development, large database entry, or School ERP.</p>
                <span className="text-3xl font-extrabold text-white mt-4 font-display">Let's Talk</span>
                <ul className="flex flex-col gap-3.5 text-xs text-gray-400 mt-6">
              ...
              <a href="#contact" className="mt-8 block text-center py-3 bg-white/5 hover:bg-white/10 text-white rounded-full text-xs font-semibold uppercase">Book Consultation</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="py-24 bg-navy-950 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">FAQ</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Frequently Asked Questions</h3>
          </div>
      ...
      {/* --- CONTACT SECTION --- */}
      <section id="contact" className="py-24 bg-navy-950/40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Info side */}
            <div className="flex flex-col gap-6">
              <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Get in Touch</h2>
              <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Let's Scale Your Operations</h3>
              ...
              <div className="flex flex-col gap-6 mt-6 text-sm text-gray-300">
                <div className="flex items-center gap-4">
                  <span className="p-3.5 bg-royal-600/15 border border-royal-500/20 text-royal-400 rounded-2xl"><FaPhone /></span>
                  <span>+1 (800) 555-EOGB (3642)</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="p-3.5 bg-royal-600/15 border border-royal-500/20 text-royal-400 rounded-2xl"><FaEnvelope /></span>
                  <span>inquire@eliteopsglobal.com</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="p-3.5 bg-royal-600/15 border border-royal-500/20 text-royal-400 rounded-2xl"><FaGlobe /></span>
                  <span>www.eliteopsglobal.com</span>
                </div>
              </div>

              {/* Logo in contact section */}
              <div className="relative w-44 h-16 mt-8 flex items-center opacity-40">
                <img src="/logo.png" alt="EliteOps Global Logo" className="w-full h-full object-contain filter grayscale" />
              </div>
            </div>

            {/* Form side */}
            <div className="glass p-8 md:p-10 rounded-3xl border border-white/5 shadow-2xl relative">
              <h4 className="font-bold text-white text-lg font-display mb-6">Consultation Form</h4>
              <form onSubmit={handleContactSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="bg-navy-900 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-royal-500 transition-colors"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs text-gray-400 font-semibold uppercase">Industry</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-1.5 sm:col-span-2">
                  <label className="text-xs text-gray-400 font-semibold uppercase">Service Required</label>
                  <select
                ...
                <div className="flex flex-col gap-1.5 sm:col-span-2">
                  <label className="text-xs text-gray-400 font-semibold uppercase">Message</label>
                  <textarea
                    rows={4}
                    required
                    value={contactData.message}
                    onChange={(e) => setContactData({ ...contactData, message: e.target.value })}
                    className="bg-navy-900 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-royal-500 transition-colors resize-none"
                  />
                </div>
              ...
              {contactMsg.text && (
                <div className={`mt-5 p-4 rounded-xl text-xs font-semibold ${contactMsg.type === 'success' ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}>
                  {contactMsg.text}
                </div>
              )}
            </div>
      ...
      {/* --- CAREERS SECTION --- */}
      <section id="careers" className="py-24 bg-navy-950 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Careers</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Join Our Global Team</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {jobs.map((job, idx) => (
              <div key={idx} className="glass p-8 rounded-3xl border border-white/5 flex flex-col justify-between h-full">
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center text-[10px] uppercase font-bold text-royal-400">
                    <span>{job.type}</span>
                    <span>{job.location}</span>
                  </div>
                  <h4 className="font-bold text-white text-lg font-display">{job.title}</h4>
                  <p className="text-xs text-gray-400 leading-relaxed">{job.desc}</p>
                </div>
                <button
                  onClick={() => {
      ...
      {/* --- BLOG SECTION --- */}
      <section id="blog" className="py-24 bg-navy-950/40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-royal-400">Our Blog</h2>
            <h3 className="text-3xl md:text-4xl font-bold font-display text-white">Latest Corporate Insights</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="glass-card rounded-3xl overflow-hidden flex flex-col justify-between border border-white/5 h-full group">
                <div className="p-6 flex flex-col gap-3">
                  <div className="flex justify-between items-center text-[10px] text-gray-500 font-semibold uppercase">
                    <span>{blog.category}</span>
                    <span>{blog.date}</span>
                  </div>
                  <h4 className="font-bold text-white text-base group-hover:text-royal-400 transition-colors font-display">{blog.title}</h4>
                  <p className="text-xs text-gray-400 leading-relaxed">{blog.desc}</p>
                </div>
                <span className="p-6 pt-0 inline-flex items-center gap-1 text-xs text-royal-400 hover:text-white font-semibold cursor-pointer">
