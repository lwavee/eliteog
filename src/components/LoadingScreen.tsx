          ...
          >
            <div className="relative w-48 h-24">
              <Image
                ...
                fill
                priority
                className="object-contain filter mix-blend-multiply opacity-80"
              />
            </div>
            
            {/* Loading text with scanning glow line */}
            <div className="relative mt-4 w-40 h-[2px] bg-slate-200 rounded-full overflow-hidden">
              <motion.div
                initial={{ left: '-100%' }}
                animate={{ left: '100%' }}
                transition={{
            ...
            <motion.p
              ...
              className="text-xs tracking-[0.2em] uppercase font-display text-royal-600"
            >
